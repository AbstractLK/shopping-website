...
<body class="my-login-page">
							...
							<div class="card-body">
								...
								<form method="POST" class="my-login-validation" novalidate="">
									...
									<div class="form-group">
										...
										<input id="password" type="password" class="form-control" name="psw" required data-eye>
										<div class="invalid-feedback">
									...
									<div class="mt-4 text-center">
										Don't have an account? <a href="register.php">Create One one</a>
									</div>
								</form>
							</div>
						</div>
	...
	<?php
		...
		if(isset($_POST['login'])) {
			// SQL QUERY
			$quary = "SELECT * FROM users WHERE email= '" . $_POST["email"] . "' AND password= '" . $_POST["psw"] . "'  ";
